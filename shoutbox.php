...
define("USER", "chuck_admin");
define("PASSWORD", "safe9010");
define("DB", "chuck_shoutbox");
	...
	switch($_POST['action']){
		case "update":
			...
			while($row = mysql_fetch_array($res)){
				$result .= "<li><strong>".$row['user']."</strong><img src=\"css/images/bullet.gif\" alt=\"-\" />".$row['message']."<br /><span class=\"date\">".$row['date']."</span></li>";
			}
			echo $result;
			break;
		case "insert":
